					...
					<td>
						...
						<tr>
							<td width="280" height="140" align="center" class="devicewidth">
								<a href="http://stlebrd://openMeeting/45/100" role="link" target="_blank"><img src="http://eboard.stl-horizon.com/php/images/login_final_mike_03.png" alt="" border="0" width="280" height="140" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img"></a>
							</td>
						</tr>
						<!-- /image -->
						</tbody>
							...
							<td>
								...
								<tr>
									<td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:left; line-height: 24px;">
										 I write to inform you all that another round of meeting.
									</td>
								</tr>
								<!-- end of content -->
								<!-- Spacing -->
								...
								<tr>
									<td>
										<table width="120" height="32" bgcolor="#e20404" align="left" valign="middle" border="0" cellpadding="0" cellspacing="0" style="border-radius:3px;" st-button="learnmore">
										<tbody>
										<tr>
										...
										<tr>
											<td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:bold;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
												<a style="text-decoration: none;color: #ffffff; text-align:center;" href="http://stlebrd://openMeeting/45/100" target="_blank" role="link">Open Meeting</a>
											</td>
										</tr>
										<tr>
											<td height="9" align="center" style="font-size:1px; line-height:1px;">
